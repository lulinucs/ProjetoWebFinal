...
async function getCandidatos(evento) {
    ...
    const res = await Axios.post("http://luli.ferreira.lucas.vms.ufsc.br:8081/candidatosNoEvento",
                {eventoId: evento._id});
...
export default class ListaEventos extends React.Component {    
    ...
    async refresh() {
        const response = await Axios.get("http://luli.ferreira.lucas.vms.ufsc.br:8081/listaeventos")
