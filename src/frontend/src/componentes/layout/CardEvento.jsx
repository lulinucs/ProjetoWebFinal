...
export default  (props) => {
    ...
    async function CandidatarSe(idEvento, googleId) {
        ...
        const res = await Axios.post("http://luli.ferreira.lucas.vms.ufsc.br:8081/candidatarse", {
            idEvento: idEvento,
    ...
    async function Deletar(idEvento) {
        ...
        const res = await Axios.post("http://luli.ferreira.lucas.vms.ufsc.br:8081/excluirevento", {
            eventoId: idEvento,
        });
